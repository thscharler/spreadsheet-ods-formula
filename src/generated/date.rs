...
/// __See also__: "DAYS", "DATEDIF",
#[inline]
pub fn days360_<A: DateTime, B: DateTime>(
    start_date: A,
    end_date: B,
    method: Days360Method,
) -> FnNumber3<A, B, Days360Method> {
...
/// the third parameter would be: {0;0;0;0;0;1;1}.
#[inline]
pub fn networkdays_<A: DateTime, B: DateTime, C: Sequence>(
    date1: A,
    date2: B,
    holidays: C,
) -> FnNumber3<A, B, C> {
...
/// the third parameter would be: {0;0;0;0;0;1;1}.
#[inline]
pub fn networkdays__<A: DateTime, B: DateTime, C: Sequence, D: Sequence>(
    date1: A,
    date2: B,
    holidays: C,
    workdays: D,
...
/// Saturday, the third parameter would be: {0;0;0;0;0;1;1}.
#[inline]
pub fn workday_<A: DateTime, B: Number, C: Sequence>(
    date: A,
    offset: B,
    holidays: C,
) -> FnNumber3<A, B, C> {
...
/// Saturday, the third parameter would be: {0;0;0;0;0;1;1}.
#[inline]
pub fn workday__<A: DateTime, B: Number, C: Sequence, D: Sequence>(
    date: A,
    offset: B,
    holidays: C,
    workdays: D,
...
/// __See also__: "DATEDIF",
#[inline]
pub fn yearfrac_<A: DateTime, B: DateTime>(
    start_date: A,
    end_date: B,
    b: YearFracMethod,
) -> FnNumber3<A, B, YearFracMethod> {
